...
<p>You'll apply your experience to help mature foundational IT systems while pioneering innovative solutions unique to the challenges of a leading AI company. Your work will directly shape how we scale to <a href="https://www.anthropic.com/news/activating-asl3-protections">AI Safety Level 4</a> and beyond.</p>
<p>This role offers significant opportunities to define the future of IT. You'll build systems impacting every employee's daily experience while contributing directly to Anthropic's mission to develop safe, transformative AI.</p>
...
<p><strong>Deadline to apply:&nbsp;</strong>None. Applications will be reviewed on a rolling basis.&nbsp;</p><div class="content-pay-transparency"><div class="pay-input"><div class="description"><p>The annual compensation range for this role is below. For sales roles, the range provided is the role’s On Target Earnings ("OTE") range, meaning that the range includes both the sales commissions/sales bonuses target and annual base salary for the role. Our total compensation package for full-time employees includes equity and benefits.</p></div><div class="title">Annual Salary:</div><div class="pay-range"><span>$225,000</span><span class="divider">&mdash;</span><span>$275,000 USD</span></div></div></div><div class="content-conclusion"><h2><strong>Logistics</strong></h2>
