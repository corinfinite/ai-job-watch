...
<p>Anthropic’s mission is to create reliable, interpretable, and steerable AI systems. We want AI to be safe and beneficial for our users and for society as a whole. Our team is a quickly growing group of committed researchers, engineers, policy experts, and business leaders working together to build beneficial AI systems.</p></div><h2><strong>Role Overview</strong></h2>
<p>As a Sales Development Manager at Anthropic, you'll lead and scale our business development function to drive pipeline generation for our frontier AI products. You'll build and manage a high-performing team of BDRs, optimize our lead management processes, and collaborate closely with sales leadership to ensure alignment between pipeline generation and revenue goals. This is a critical role in scaling Anthropic's go-to-market engine during a period of hyper-growth.</p>
<h2><strong>Key Responsibilities</strong></h2>
<ul>
<li>Build, lead, and scale a team of 8-12 BDRs focused on both inbound lead management and strategic outbound prospecting</li>
<li>Partner with sales leadership to align pipeline generation with revenue targets across Startup and Enterprise segments</li>
<li>Establish and track KPIs for lead quality, conversion rates, and pipeline contribution</li>
<li>Create comprehensive training programs and career development paths for BDRs</li>
<li>Collaborate with marketing to optimize lead quality and campaign effectiveness</li>
<li>Drive adoption of sales tools and technologies (Salesforce, HubSpot, SQL) to improve team efficiency</li>
<li>Own Pipeline Reviews with sales leadership - covering top of funnel health, conversion metrics, outbound progress, and marketing support / follow-through&nbsp;</li>
<li>Manage relationships with cross-functional stakeholders including sales, marketing, and operations</li>
<li>Build scalable processes to support Anthropic's rapid growth</li>
<li>Coach and mentor BDRs on prospecting strategies, qualification techniques, and career development</li>
</ul>
<h2><strong>Qualifications</strong></h2>
<ul>
<li>3-5 years of experience managing BDR teams, preferably in high-growth SaaS or technology companies</li>
<li>Proven track record of building and scaling successful BDR teams</li>
<li>Strong analytical skills with experience using data to drive decision-making</li>
<li>Experience with Salesforce, HubSpot, and sales analytics tools</li>
<li>Demonstrated ability to develop and implement effective sales processes</li>
<li>Excellent communication and leadership skills</li>
<li>Experience in API-first or consumption-based business models preferred</li>
<li>Bachelor's degree or equivalent work experience</li>
</ul>
<h2><strong>Preferred Experience</strong></h2>
<ul>
<li>Experience managing teams in AI/ML or developer-focused companies</li>
<li>Background in both inbound and outbound lead generation strategies</li>
<li>Track record of developing BDRs who successfully transition to AE roles</li>
<li>Experience building teams from scratch in early-stage companies</li>
</ul><div class="content-pay-transparency"><div class="pay-input"><div class="description"><p>The annual compensation range for this role is below. For sales roles, the range provided is the role’s On Target Earnings ("OTE") range, meaning that the range includes both the sales commissions/sales bonuses target and annual base salary for the role. Our total compensation package for full-time employees includes equity and benefits.</p></div><div class="title">Annual Salary:</div><div class="pay-range"><span>$165,000</span><span class="divider">&mdash;</span><span>$245,000 USD</span></div></div></div><div class="content-conclusion"><h2><strong>Logistics</strong></h2>
