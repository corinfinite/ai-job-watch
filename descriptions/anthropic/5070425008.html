...
<ul>
<li>Understand how Anthropic's security and privacy capabilities across major cloud platforms implement common frameworks (e.g., NIST 800-53, NIST 800-171, ISO 27001, ISO 27701, CSA CCM, and SOC 2).</li>
<li>Build scalable data center and cloud compliance processes and documentation systems that will support future expansion to additional geographies and compliance frameworks.</li>
<li>Assess and mitigate security and operational risks, implementing corrective actions, and managing vendor compliance.</li>
<li>Coordinate engagements with independent assessors to earn security and privacy certifications and attestations important to Anthropic customers and enterprise partnerships, and to meet regulatory obligations.</li>
<li>Write, update and enact policies capturing security, privacy, and AI safety requirements.</li>
<li>Maintain and enhance Anthropic's system of security controls through audit readiness, recordkeeping, and cross-functional communication.</li>
</ul>
<h2><strong>You may be a good fit if you:</strong></h2>
<ul>
<li>Have 8+ years of progressive experience in audit and compliance roles, with direct ownership of certification/attestation projects</li>
<li>Have worked in cloud-native environments and understand security and privacy considerations for multi-cloud architectures</li>
<li>Can translate complex compliance requirements into actionable workstreams for technical and non-technical stakeholders</li>
<li>Have built common controls frameworks or GRC systems that scaled with organizational growth</li>
<li>Write clear and useful security and privacy documentation for both external and internal audiences.</li>
<li>Thrive in ambiguous, fast-paced environments where you'll need to build processes from scratch</li>
<li>Are comfortable organizing time-bounded task management of delegated work streams across a diverse organization</li>
<li>Are energized by being the subject matter expert who educates the organization on new compliance requirements</li>
</ul>
<h2><strong>Strong candidates may also:&nbsp;</strong></h2>
<ul>
<li>Have worked in AI/ML companies and understand unique security considerations for model development and deployment</li>
<li>Have worked with cloud companies and understand cloud security controls and physical security requirements</li>
<li>Bring experience from high-growth technology companies managing rapid compliance expansion</li>
<li>Have some experience implementing automated enforcement of security controls (i.e., compliance as code)</li>
...
<p><strong>Deadline to Apply:&nbsp;</strong>None, applications will be received on a rolling basis.</p><div class="content-pay-transparency"><div class="pay-input"><div class="description"><p>The annual compensation range for this role is below. For sales roles, the range provided is the role’s On Target Earnings ("OTE") range, meaning that the range includes both the sales commissions/sales bonuses target and annual base salary for the role. Our total compensation package for full-time employees includes equity and benefits.</p></div><div class="title">Annual Salary:</div><div class="pay-range"><span>$255,000</span><span class="divider">&mdash;</span><span>$345,000 USD</span></div></div></div><div class="content-conclusion"><h2><strong>Logistics</strong></h2>
