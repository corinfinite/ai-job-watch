...
<p>The Claude Code team has revolutionized the way people build software. They are a scrappy team that is obsessed with users and have fostered an incredible iterative feedback loop. Given the high demand, the scale of impact is really exciting for this team and the Operator that joins to help accelerate growth.</p>
...
<li>Experience building with AI directly. You likely tinker to make tools and products yourself</li>
<li>A track record of building processes and programs from 0 to 1 and scaling them thoughtfully</li>
...
</ul><div class="content-pay-transparency"><div class="pay-input"><div class="description"><p>The annual compensation range for this role is below. For sales roles, the range provided is the role’s On Target Earnings ("OTE") range, meaning that the range includes both the sales commissions/sales bonuses target and annual base salary for the role. Our total compensation package for full-time employees includes equity and benefits.</p></div><div class="title">Annual Salary:</div><div class="pay-range"><span>$240,000</span><span class="divider">&mdash;</span><span>$260,000 USD</span></div></div></div><div class="content-conclusion"><h2><strong>Logistics</strong></h2>
