...
<p>Since launch, the Anthropic API has seen rapid growth and adoption by companies of all sizes to build AI applications with our industry-leading models. We're looking for experienced leaders to lead teams within our <a href="https://www.claude.com/platform/api">Claude Developer Platform</a> organization, which is responsible for the Anthropic API and developer experiences. The team owns the end-to-end flow for using the Anthropic API, including everything from documentation and SDKs to prompt engineering and model customization tools.</p>
<h2><strong>EMs currently hiring:</strong></h2>
<h3>Platform Tools</h3>
<p>Increasingly complex businesses are building integrations on top of the Claude Developer Platform. The Platform Tools team has a goal to spend time with these customers, learn what they need in order to build the integrations they need to build, and improve the platform to support these use cases.</p>
<h3>API</h3>
<p>You'll work on shipping the world's most intelligent and capable APIs, partnering directly with research to bring frontier capabilities to developers. This team owns core capabilities including vision, tool use, and computer use. Your work will directly impact how developers interact with our most advanced models.</p>
<h2><strong>Responsibilities:</strong></h2>
<ul>
<li>Lead a team in crafting an industry-defining developer experience for building AI applications</li>
<li>Collaborate with product and research teams to define the vision and developer roadmap</li>
<li>Create clarity for the team and stakeholders in an ambiguous and evolving environment&nbsp;</li>
<li>Work cross functionally to design clear interfaces and processes for shipping products that span many teams</li>
<li>Take an inclusive, equitable approach to hiring and coaching top technical talent, and maintain a high performing team</li>
</ul>
<h2><strong>You may be a good fit if you have:</strong></h2>
<ul>
<li>5+ years of experience as an engineering manager</li>
<li>A background in fullstack development - comfortable diving into various technology stacks frontend, backend, and at times deeper infrastructure.</li>
<li>A strong product mindset, able to navigate through ambiguity, and willingness to wear multiple hats (e.g. product management, design)</li>
