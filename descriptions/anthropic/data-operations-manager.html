...
<p>We're looking for someone who gets excited about the challenge of scaling quality across diverse research areas—someone who can understand nuanced technical requirements, build the right partnerships, and execute flawlessly. If you thrive at the intersection of operational excellence and cutting-edge AI research, we'd love to hear from you.</p>
<h2>Responsibilities:</h2>
<ul>
<li>Own and execute data strategy for research teams advancing frontier AI capabilities across RLHF, safety, tool use, and agentic workflows</li>
<li>Drive strategic vendor partnerships and build scalable frameworks for technical data collection at scale</li>
<li>Design and implement operational systems that translate research requirements into high-quality data pipelines</li>
<li>Build evaluation frameworks and quality standards that ensure data meets the bar for training state-of-the-art AI systems</li>
<li>Lead cross-functional initiatives to optimize research velocity while maintaining rigorous quality standards</li>
<li>Proactively identify risks, bottlenecks, and opportunities to improve efficiency and effectiveness across data operations</li>
<li>Partner with senior research leaders to align data operations with model development roadmaps and strategic priorities</li>
</ul>
<h2>You may be a good fit if you:</h2>
<ul>
<li>Have 3+ years in operations, consulting, product management, or program management roles</li>
<li>Have exceptional project management skills with ability to handle multiple complex projects simultaneously</li>
<li>Have strong communication skills and can engage effectively with technical and non-technical stakeholders</li>
<li>Are familiar with how LLMs work or have strong interest in understanding AI training methodologies</li>
<li>Are highly organized and can navigate ambiguity effectively</li>
<li>Have experience with data analysis tools (SQL, Python, Tableau, spreadsheets, or similar)</li>
<li>Thrive in fast-paced research environments with shifting priorities</li>
<li>Are passionate about AI safety and understand the critical importance of high-quality data</li>
</ul>
<h2>Strong candidates may also have:</h2>
<ul>
<li>Experience with data collection, labeling, or annotation operations for AI/ML systems</li>
<li>Knowledge of RLHF, constitutional AI, or human-in-the-loop workflows</li>
<li>Background working with research teams at AI companies or research-oriented organizations</li>
<li>Experience managing vendor relationships or external contractors</li>
<li>Consulting background with experience translating complex requirements into deliverables</li>
<li>Track record of implementing process improvements or quality control systems at scale</li>
